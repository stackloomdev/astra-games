/** Every outbound link to the upstream project, in one place. */
export const UPSTREAM_REPO = 'https://github.com/MartinDelophy/awesome-gpt-6-astra';
export const SITE_REPO = 'https://github.com/stackloomdev/astra-games';
...
export const COMMUNITY = 'https://linux.do/';
