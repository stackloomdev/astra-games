...
import fallbackSnapshot from './catalog-fallback.json' with { type: 'json' };
...
export const README_PATH = process.env.ASTRA_README_PATH || 'README.zh-CN.md';
...
function readFallback() {
  return Array.isArray(fallbackSnapshot?.works) ? fallbackSnapshot : null;
}
...
export function createCatalogService({
  ...
  async function refresh() {
    ...
    try {
      ...
      const previous = lastGood || (readmePath === README_PATH ? fallback : null);
      cachedResult = {
