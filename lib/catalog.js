...
export const README_URL = `https://github.com/${REPOSITORY}/blob/main/${README_PATH}`;
export const RAW_URL = `https://raw.githubusercontent.com/${REPOSITORY}/main/${README_PATH}`;
